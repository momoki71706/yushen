...
export const api = {
  ...
  getSmultronWindows: () => request('/smultron/windows'),
  createSmultronWindow: (name) => request('/smultron/windows', { method: 'POST', body: JSON.stringify({ name }) }),
  updateSmultronWindow: (id, payload) => request(`/smultron/windows/${id}`, { method: 'PATCH', body: JSON.stringify(payload) }),
  deleteSmultronWindow: (id) => request(`/smultron/windows/${id}`, { method: 'DELETE' }),
  activateSmultronWindow: (id) => request(`/smultron/windows/${id}/activate`, { method: 'POST' }),
  getSmultronEntries: (id) => request(`/smultron/windows/${id}/entries`),
  smultronGenerate: (id, instruction) => request(`/smultron/windows/${id}/generate`, { method: 'POST', body: JSON.stringify({ instruction }) }),
  smultronRegenerate: (id) => request(`/smultron/windows/${id}/regenerate`, { method: 'POST' }),
  smultronSyncMemory: (id) => request(`/smultron/windows/${id}/sync-memory`, { method: 'POST' }),
  smultronExport: (id) => request(`/smultron/windows/${id}/export`),
  getSmultronPresets: () => request('/smultron/presets'),
  createSmultronPreset: (payload) => request('/smultron/presets', { method: 'POST', body: JSON.stringify(payload) }),
  updateSmultronPreset: (id, payload) => request(`/smultron/presets/${id}`, { method: 'PATCH', body: JSON.stringify(payload) }),
  deleteSmultronPreset: (id) => request(`/smultron/presets/${id}`, { method: 'DELETE' }),
