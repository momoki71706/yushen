...
function diaryEntryAsHistoryTurn(entry) {
  return { from: entry.author, text: `${entry.author === 'me' ? '小晴' : '你'}写了一篇日记，心情：${entry.mood}，天气：${entry.weather}。内容：${entry.excerpt}` };
}
